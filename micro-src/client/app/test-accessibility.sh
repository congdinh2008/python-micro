...
echo "==========================================="
echo "🎨 Responsive Design & Accessibility Tests"
echo "==========================================="
echo ""
...
echo "⌨️  KEYBOARD NAVIGATION TESTING"
echo "-------------------------------------------"
...
echo "   - Right-click any text → Inspect"
echo "   - In Styles panel, click color value"
echo "   - View contrast ratio (should be ≥ 4.5:1 for text)"
echo ""
...
echo "   - Primary-600 on White: 7.2:1 ✓ (AA Pass)"
echo "   - Gray-900 on White: 16.1:1 ✓ (AAA Pass)"
echo "   - Gray-600 on White: 7.6:1 ✓ (AA Pass)"
echo ""
...
echo "🧪 TOAST NOTIFICATION TESTING"
echo "-------------------------------------------"
...
echo "   - Add item to cart → Info toast"
echo "   - Remove item → Info toast with undo"
echo "   - Clear cart → Info toast"
echo ""
echo "4. Toast Queue:"
...
if [ -f "package.json" ]; then
  ...
  echo "⚠️  Run this script from the app directory"
